...
class Lakend_Notifier_Admin {
    ...
    public function render_sending_mode_field() {
        ...
        <label style="display: block; margin-bottom: 10px;">
            <input type="radio" 
                   name="lakend_notifier_settings[sending_mode]" 
                   value="both" 
                   <?php checked( $value, 'both' ); ?>>
            <?php esc_html_e( 'Send to both email and Telegram', 'lakend-notifier' ); ?>
        </label>
        <label style="display: block;">
            <input type="radio" 
                   name="lakend_notifier_settings[sending_mode]" 
                   value="email_only_notify" 
                   <?php checked( $value, 'email_only_notify' ); ?>>
    ...
    public function render_channel_mapping_field() {
        ...
        <div id="lakend-channel-mapping" style="max-width: 800px;">
            ...
            <div class="lakend-mapping-item" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border: 1px solid #ddd; border-radius: 4px;">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <input type="text" 
                        ...
                        class="regular-text">
                    <select name="lakend_notifier_settings[channel_mapping][booking][]" 
                            multiple 
            ...
            <div class="lakend-mapping-item" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border: 1px solid #ddd; border-radius: 4px;">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <input type="text" 
                        ...
                        style="width: 150px; background: #f0f0f0;"
                        class="regular-text">
                    <select name="lakend_notifier_settings[channel_mapping][customer_email][]" 
                            multiple 
            ...
            <div class="lakend-mapping-item" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border: 1px solid #ddd; border-radius: 4px;">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <input type="text" 
                        ...
                        style="width: 150px; background: #f0f0f0;"
                        class="regular-text">
                    <select name="lakend_notifier_settings[channel_mapping][default][]" 
                            multiple 
                            style="width: 300px; height: 80px;">
                ...
                <div id="lakend-custom-types-container">
                    ...
                    foreach ( $mapping as $type => $channels ) {
                        if ( ! in_array( $type, array( 'booking', 'customer_email', 'default', 'test', 'intercepted_wp_mail' ) ) ) {
                            ?>
                            <div class="lakend-custom-type-row" style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                                <input type="text" 
                                    name="lakend_notifier_settings[channel_mapping_custom_type][]" 
                                    value="<?php echo esc_attr( $type ); ?>" 
                                    placeholder="<?php esc_attr_e( 'Type name', 'lakend-notifier' ); ?>"
                                    style="width: 150px;">
                                <select name="lakend_notifier_settings[channel_mapping_custom_channels][]" 
                                        multiple 
    ...
    public function render_enable_logging_field() {
        ...
        <label>
            <input type="checkbox" 
                   name="lakend_notifier_settings[enable_logging]" 
                   value="1" 
                   <?php checked( $value, 1 ); ?>>
    ...
    public function render_intercept_all_wp_mail_field() {
        ...
        <label>
            <input type="checkbox" 
                   name="lakend_notifier_settings[intercept_all_wp_mail]" 
                   value="1" 
                   <?php checked( $value, 1 ); ?>>
    ...
    public function render_email_from_address_field() {
        ...
        ?>
        <input type="email" 
               name="lakend_notifier_settings[email_from_address]" 
    ...
    public function render_email_from_name_field() {
        ...
        ?>
        <input type="text" 
               name="lakend_notifier_settings[email_from_name]" 
               value="<?php echo esc_attr( $value ); ?>" 
               class="regular-text">
        <p class="description">
    ...
    public function render_email_default_recipients_field() {
        ...
        ?>
        <input type="text" 
               name="lakend_notifier_settings[email_default_recipients]" 
               value="<?php echo esc_attr( $value ); ?>" 
               class="regular-text">
        <p class="description">
    ...
    public function render_telegram_bot_token_field() {
        ...
        ?>
        <input type="password" 
               name="lakend_notifier_settings[telegram_bot_token]" 
               value="<?php echo esc_attr( $value ); ?>" 
               class="regular-text">
        <p class="description">
            <?php 
    ...
    public function render_telegram_chat_id_field() {
        ...
        ?>
        <input type="text" 
               name="lakend_notifier_settings[telegram_chat_id]" 
               value="<?php echo esc_attr( $value ); ?>" 
               class="regular-text">
        <p class="description">
    ...
    public function render_direct_test_page() {
        ...
        require_once LAKEND_NOTIFIER_PATH . 'includes/test-email-direct.php';
    }
